...
function gotResult(error, result){
 if (error) {
  ...
  console.log(result);
  document.getElementById("sketch").innerHTML="Your sketch detected as = " +result[0].label;
  drawn_sketch=result[0].label;
  document.getElementById("confidence").innerHTML="Sketch Confidence = "+ Math.round(result[0].confidence *100)+"%";
